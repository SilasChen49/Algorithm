...
bool reduce_horizontal_seam_trivial(cv::Mat& in_image, cv::Mat& out_image, int seam[]);


bool reduce_vertical_seam_trivial(cv::Mat& in_image, cv::Mat& out_image, int seam[]);
